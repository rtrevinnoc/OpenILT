...
import pyverilator
dut = pyverilator.PyVerilator.build('/Users/rtrevinnoc/MNNW/lithographyAccelerator/lithography_accelerator.v')
...
if __name__ == "__main__":
    ...
    plt.subplot(1, 2, 2)
    plt.imshow(printed.detach().cpu().numpy())
    plt.show()